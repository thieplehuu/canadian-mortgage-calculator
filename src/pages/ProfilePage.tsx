...
export default function ProfilePage() {
    ...
    return (
        ...
        <View style={[AppStyle.StyleMain.container, {
            ...
            <View>
                <Button containerStyle={[AppStyle.StyleMain.buttonContainer, {marginTop:12}]} buttonStyle={AppStyle.StyleMain.buttonFullwidthOutlined} 
                    titleStyle={{
                        color:"#816CEC",
                        fontSize:20
                    }} 
                ...
                <Button containerStyle={[AppStyle.StyleMain.buttonContainer, {marginTop:12}]} buttonStyle={AppStyle.StyleMain.buttonFullwidthStyle} 
                    titleStyle={{
                        color:"white",
                        fontSize:20
                    }} 
