      ...
      <KeyboardAwareScrollView
        ...
        <View style={AppStyle.StyleMain.container}>
          ...
          <View style={styles.row}>
            ...
            <View style={styles.column}>
              <Text style={AppStyle.TextStyle.text9}>
                {moneyFormat(totalDebt)}
              </Text>
            </View>
            <View style={styles.column}>
              <Text style={AppStyle.TextStyle.text9}>
                {moneyFormat(monthlyPayment)}
              </Text>
            </View>
          </View>
          <View>
            <View style={styles.totalSavingPanel}>
              <Text style={styles.totalSavingPanelTextLabel}>
                Monthly Savings of
              </Text>
              <Text style={styles.totalSavingPanelTextValue}>
                {moneyFormat((monthlyPayment - newPayment)?.toFixed(2))}
              </Text>
            </View>
          </View>
        </View>
          ...
          <DropShadow
            ...
            <View style={AppStyle.StyleMain.footerContainer}>
              <View style={AppStyle.StyleMain.footerLeftColumn}>
                <Text style={AppStyle.TextStyle.text5}>
                  New Monthly Payment
                </Text>
                <Text style={AppStyle.TextStyle.text6}>
                  {moneyFormat(newPayment)}
                </Text>
              </View>
