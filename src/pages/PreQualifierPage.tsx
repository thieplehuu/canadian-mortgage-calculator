...
export default function PreQualifierPage() {
  ...
  const [gdsv, setGdsv] = useState(50.0);
        ...
        <View style={AppStyle.StyleMain.container}>
          ...
          <View style={AppStyle.Base.sliderLabelContainer}>
            <View style={{alignContent: 'flex-start'}}>
              <Text>{moneyRound(minAmount, true, false)}</Text>
            </View>
            <View style={{alignSelf: 'stretch'}}></View>
            <View style={{alignContent: 'flex-end'}}>
              <Text>{moneyRound(maxAmount, true, true)}</Text>
            </View>
          </View>
          <OutlinedCurrencyInput
            label="Property Tax"
                    ...
                    popover={
                      <View>
                        <Text style={{color: 'white'}}>
                          + ${Separator(dp, true)} (20% Minimum Down Payment
                          Required) = ${Separator(pp, true)}
                        </Text>
                      </View>
                    }>
